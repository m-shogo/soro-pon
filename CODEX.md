...
post-Batch-10 integrity definitions: 79 committed, exact-SHA execution pending
```
...
5. Record Node/pnpm/Playwright/browser versions.
6. pnpm install --frozen-lockfile
7. Run the 23-file Integrity Contracts workflow equivalent.
8. Confirm all 79 review-added definitions are collected and pass.
9. pnpm typecheck
10. pnpm test
11. pnpm skin:validate
12. pnpm build + artifact inventory/hash
13. If any file changes, restart from step 1.
14. Execute Batch 11 on the same production artifact.
15. Commit report/evidence; then synchronize readiness docs.
```
...
external package official trust never comes from manifest self-declaration
```
