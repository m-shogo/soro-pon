...
for (const needle of [
  ...
  ".sp-table-stage--4 [data-seat-position='self'] .sp-seat-played",
  'bottom: 72px;',
  'bottom: 96px;',
  'width: min(100%, 980px);',
]) {
...
for (const needle of [
  ...
  requireText('visual', needle, 'canonical evidence must preserve compact coverage while strictly separating desktop seat and river geometry');
}
