...
- Batch 13 darwin Playwright snapshots are legacy regression material only; they are not Batch 14 approval.
...
3. Identify the weakest three visible problems before adding decoration.
4. Fix hierarchy, spacing, occlusion, text density and interaction emphasis before visual effects.
5. Re-run the artifact capture on the new HEAD.
