...
| B13-PYTHON | local + exact-SHA CI | asset fixtures green | 92/92 local 3.14.5; CI 3.13 green with `pip check` | PASS | preview candidate `e6bcb82c…` |
| B13-CI | GitHub PR exact SHA | CI green | run `30253119733` SUCCESS | PASS | preview candidate `e6bcb82c…` |
| B13-CI-INTEGRITY | GitHub PR exact SHA | workflow green | run `30253119813` SUCCESS | PASS | preview candidate `e6bcb82c…` |
